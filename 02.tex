...
%\begin{figure}[htbp]
%    \begin{center}
%        \fbox {\includegraphics[width=90mm]{images/evernote.png}} \end{center}
...
%\begin{figure}[htbp]
%    \begin{center}
%        \fbox{\includegraphics[width=50mm]{images/googlekeep.png}} \end{center}
...
\begin{figure}[htbp] \begin{minipage}{0.5\hsize}
                         \begin{center} \fbox {\includegraphics[width=50mm]{images/addlink1.PNG}}
                         \end{center} \caption{evernote} \label{fig:evernote}
\end{minipage} \begin{minipage}{0.5\hsize}
                   \begin{center} \fbox {\includegraphics[width=50mm]{images/googlekeep.png}}
